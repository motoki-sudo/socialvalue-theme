...
/* === ACF: Practices 詳細（workresult 対象に変更） === */
if ( function_exists('acf_add_local_field_group') ) {
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      ['key'=>'pd_overview','label'=>'事業概要','name'=>'pd_overview','type'=>'wysiwyg','tabs'=>'all','toolbar'=>'full','media_upload'=>0],
      ['key'=>'pd_objective','label'=>'評価目的','name'=>'pd_objective','type'=>'wysiwyg','tabs'=>'all','toolbar'=>'full','media_upload'=>0],
      [
        'key'=>'pd_methods','label'=>'評価方法','name'=>'pd_methods','type'=>'repeater','layout'=>'table','button_label'=>'+方法を追加',
        'sub_fields' => [[ 'key'=>'pd_methods_text','label'=>'テキスト','name'=>'text','type'=>'text' ]]
      ],
      [
        'key'=>'pd_interim','label'=>'中間評価の結果','name'=>'pd_interim','type'=>'repeater','layout'=>'row','button_label'=>'+ブロックを追加',
        'sub_fields' => [
          ['key'=>'pd_interim_sub','label'=>'サブタイトル','name'=>'subtitle','type'=>'text'],
          ['key'=>'pd_interim_txt','label'=>'本文','name'=>'text','type'=>'wysiwyg','tabs'=>'all','toolbar'=>'basic','media_upload'=>0],
          ['key'=>'pd_interim_img','label'=>'画像','name'=>'image','type'=>'image','return_format'=>'id','preview_size'=>'medium'],
        ]
      ],
      ['key'=>'pd_utilization','label'=>'クライアントによる評価の活用','name'=>'pd_utilization','type'=>'wysiwyg','tabs'=>'all','toolbar'=>'full','media_upload'=>0],
      [
        'key'=>'pd_related_category','label'=>'関連記事の元となるカテゴリ','name'=>'pd_related_category',
        'type'=>'taxonomy','taxonomy'=>'workresult_category','field_type'=>'select','return_format'=>'id','add_term'=>0
      ],
    ],
  ]);
}
